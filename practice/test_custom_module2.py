...
history_base = '/home/blaughli/tracking_project/history_files/'
seed_base = '/home/blaughli/tracking_project/practice/seed_input_files/'
        

#-------- History File -----------------
#his_file_pre = 'wc12_his.nc'
#his_file_pre = 'wc12_his_dummy_zeros.nc'
#his_file_pre = 'wc12_his_v0_Ks_1e-3.nc'
#his_file_pre = 'wc12_his_v0_Ks_linear_1e-2_1e-1.nc'
#his_file_pre = 'wc12_his_v0_Ks_1e-4.nc'
#his_file_pre = 'wc12_his_v0_Ks_0_base.nc'
#his_file_pre = 'wc12_his_v0_Ks_linear_1e-4_1e-1.nc'
#his_file_pre = 'wc12_his_v0_Ks_tanh_1e-3_1.nc'
his_file_pre = 'wc12_his_v0_Ks_Kt_Kv_0.nc'

#---------------------------------------
his_file = history_base + his_file_pre


#----------Seed File---------------------
#seed_file_name = 'seed_turbulence_test_psi_line_slope1.txt'
seed_file_pre = 'seed_turbulence_test_psi_uniform.txt'
...
model_output_pre = '/home/blaughli/tracking_project/turbulence_study/tracking_output/'
...
nc_output_file = 'turbulence_study/profile_turb_study_wc12_his_v0_Ks_Kt_Kv_0.nc_psi_uniform_MIX_OFF.nc'
