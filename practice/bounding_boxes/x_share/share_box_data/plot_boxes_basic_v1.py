# Basic script for sharing box lon/lat with collaborators
...
# -----------------------------------------------------------------------------------------
# If you are running this from an IDE like Spyder, you can comment out line 65 and un-comment
# either line 67 (to plot the SCB region) or line 68 (to plot the entire domain)
# -----------------------------------------------------------------------------------------
...
# either line 67 (to plot the SCB region) or line 68 (to plot the entire domain)
# -----------------------------------------------------------------------------------------
switch_plot_islands = bool(int(sys.argv[1])) 
# -----------------------------------------------------------------------------------------
#switch_plot_islands = True # UNcomment one of these if
