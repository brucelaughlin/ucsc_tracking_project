...
save_file = strcat('dist_2_coast_field_',point_type_field,'_coastline_wc15_no_islands.mat')
...
coast_lon_file = strcat('coast_coords_',point_type_line,'_wc15_continent_lon.txt')
coast_lat_file = strcat('coast_coords_',point_type_line,'_wc15_continent_lat.txt')
