...
grid_dir = 'grid_data/'
file_dir = 'practice/bounding_boxes/create_boxes/'
grid_file = 'wc15_grd_no_islands.nc'

grid_path = strcat(base_dir,grid_dir,grid_file)


isoline_coord_file_in = 'isodistance_ij_coords_{}_coastline_wc15_no_islands.p'.format(point_type_field)
coast_coords_in_i = 'coast_coords_{}_wc15_continent_i.txt'.format(point_type_line)
coast_coords_in_j = 'coast_coords_{}_wc15_continent_j.txt'.format(point_type_line)
bounding_boxes_file_out = 'wall_ij_coords_{}_coastline_wc15_continental.p'.format(point_type_line)
