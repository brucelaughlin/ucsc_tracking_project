...
# THIS IS WRONG BECAUSE COASTLINE IS AT PSI POINTS EXACTLY, AND OFFSHORE POINTS
# ARE FROM RHO GRID.  SO DOESN'T MAKE SENSE TO INTERPOLATE OFFSHORE
# POINTS TO PSI GRID LAT/LON.  HOWEVER, NEW VERSION WILL JUST USE
# LAT/LON AS COORDINATES, NO MORE I/J THROUGHOUT
...
coastline_lon = lon_line[coast_ij[:,0],coast_ij[:,1]]
coastline_lat = lat_line[coast_ij[:,0],coast_ij[:,1]]

ax.plot(coastline_lon,coastline_lat)
