...
box_file_dir = 'practice/bounding_boxes/create_boxes/aa_islands/'
output_dir = base_dir + box_file_dir + 'z_output/'
...
for island_dex in range(6,num_islands+1):


    isoline_coord_file_in = output_dir + 'isodistance_lonlat_coords_{}_coastline_wc15_island_number_{}.p'.format(point_type_field,island_dex)
    coast_coords_in = output_dir + 'coastline_coords_wc15_island_number_{}.p'.format(island_dex)
    bounding_boxes_file_out = output_dir + 'bounding_boxes_lonlat_wc15_island_number_{}.p'.format(island_dex)
