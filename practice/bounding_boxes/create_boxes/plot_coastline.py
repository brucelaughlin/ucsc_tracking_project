...
#grid_file_in = 'wc15_grd_{}.nc'.format(land_type)
...
if land_type == 'continent':
    coastline_coords_file_in = box_dir + input_file_dir + 'coastline_coords_psi_file_wc15_{}.p'.format(land_type)
else:
    coastline_coords_file_in = box_dir + islands_dir + input_file_dir + 'coastline_coords_psi_file_wc15_{}.p'.format(land_type)
