...
grid_file = '/home/blaughli/opendrift_stuff/grid_stuff/wc12_grd_no_islands.nc';
...
fileID = fopen('coast_coords_psi_i.txt','r');
formatSpec = '%f';
coast_psi_i = fscanf(fileID,formatSpec);
fclose(fileID);
coast_psi_i = coast_psi_i + 1;

fileID = fopen('coast_coords_psi_j.txt','r');
formatSpec = '%f';
...
save('dist_2_coast_field_wc12.mat','dist_field')
