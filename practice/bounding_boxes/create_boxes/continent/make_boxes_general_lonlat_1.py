...
box_file_dir = 'practice/bounding_boxes/create_boxes/continent/'
output_dir = 'z_output/'
...
isoline_coord_file_in = base_dir + box_file_dir + output_dir + 'isodistance_lonlat_coords_{}_coastline_wc15n_continent.p'.format(point_type_field)

#coast_coords_in = base_dir + box_file_dir + output_dir + 'coastline_coords_{}_file_wc15_continent.p'.format(point_type_line)
coast_coords_in = base_dir + box_file_dir + output_dir + 'coastline_coords_{}_file_wc15n_continent.p'.format(point_type_line)
...
bounding_boxes_file_out = base_dir + box_file_dir + output_dir + 'bounding_boxes_lonlat_coords_{}_coastline_wc15n_continent.p'.format(point_type_line)
