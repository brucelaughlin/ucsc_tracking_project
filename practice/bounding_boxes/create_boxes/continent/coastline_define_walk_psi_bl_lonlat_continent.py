...
psi_bl_directory = 'practice/bounding_boxes/create_boxes/continent/z_modify_psi/'
output_dir = 'z_output/'
...
psi_bl_file_in = 'mask_psi_bl_continent.p'
psi_bl_path_in = base_path + psi_bl_directory + psi_bl_file_in

#coastline_file_out = output_dir + 'coastline_coords_psi_file_wc15_continent.p'
coastline_file_out = output_dir + 'coastline_coords_psi_file_wc15n_continent.p'
