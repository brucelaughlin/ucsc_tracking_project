...
blob_north_isoline_file_pre = 'coastline_coords_wc15n_island_1_through_4_combined_north.p'
blob_north_isoline_file = input_dir + blob_north_isoline_file_pre        
        
blob_south_isoline_file_pre = 'coastline_coords_wc15n_island_1_through_4_combined_south.p'
blob_north_isoline_file = input_dir + blob_south_isoline_file_pre        

isoline_file_pre = 'isodistance_lonlat_coords_rho_coastline_wc15n_island_1_through_4_blob.p'
isoline_file = input_dir + isoline_file_pre
