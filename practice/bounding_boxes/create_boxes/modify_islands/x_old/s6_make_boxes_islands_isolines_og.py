...
fixed_wall_blob_file_pre = "islands_blob_fixed_wall_coords.txt"
fixed_wall_blob_file = box_dir + islands_dir + fixed_wall_blob_file_pre
...
file = open(box_dir + islands_dir + 'island_isoline_bounding_points_rotated_V2.txt','r')
#file = open(box_dir + islands_dir + 'island_isoline_bounding_points_V2.txt','r')
