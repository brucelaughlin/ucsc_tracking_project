...
input_dir = box_dir + islands_dir + 'z_output/z_originals/'
output_dir = box_dir + islands_dir + 'z_output/'

text_file_dir = "v_point_text_files/"

isoline_bp_text_file = 'island_isoline_bounding_points_rotated_V2.txt'
isoline_bp_text_path = box_dir + islands_dir + text_file_dir + isoline_bp_text_file

isoline_bp_file_in = text_file_dir + 'island_isoline_bounding_points_V4.txt'
#isoline_bp_file_in = 'island_isoline_bounding_points_V2.txt'
...
file = open(box_dir + islands_dir + isoline_bp_file_in,'r')
...
#for island_dex in range(num_last_blob_island,num_last_blob_island+1):   
    ...
    if island_dex == num_last_blob_island:
        ...
        output_file = output_dir + 'isodistance_lonlat_coords_rho_coastline_wc15n_island_1_through_4_blob_rotated.p'
    else:
        isoline_file_in = input_dir + 'isodistance_lonlat_coords_rho_coastline_wc15n_island_number_{}.p'.format(island_dex)
        output_file = output_dir + 'isodistance_lonlat_coords_rho_coastline_wc15n_island_number_{}_rotated.p'.format(island_dex)
