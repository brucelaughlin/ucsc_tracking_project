...
file = open(box_dir + islands_dir + 'artificial_coastline_insertion_points_2.txt','r')
...
for island_dex in range(1,num_islands+1):   
    ...
    if island_dex < 5:
        ...
        ax.scatter(coastline[bridge_point_list[bp_dex][1],0],coastline[bridge_point_list[bp_dex][1],1],c='red')
        bp_dex += 1
