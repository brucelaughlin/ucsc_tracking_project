...
points_in_boxes_file_in_islands_inshore = points_dir + 'z_output/' + 'points_in_boxes_lon_lat_islands_inshore.p'
points_in_boxes_file_in_islands_offshore = points_dir + 'z_output/' + 'points_in_boxes_lon_lat_islands_offshore.p'
...
file = open(points_in_boxes_file_in_islands_inshore,'rb')
points_in_boxes_islands_inshore = pickle.load(file)
file.close

file = open(points_in_boxes_file_in_islands_offshore,'rb')
points_in_boxes_islands_offshore = pickle.load(file)
file.close
