...
points_in_boxes_ij_islands_inshore = []
points_in_boxes_ij_islands_offshore = []
        ...
        for box_lonlat in boxes_lonlat:
            if box_lonlat is not None:
                ...
                if inoffshore_switch == 0:
                    ...
                    points_in_boxes_ij_islands_inshore.append(points_box_i_j)
                else:
                    points_in_boxes_lonlat_islands_offshore.append(points_box_lon_lat)
                    points_in_boxes_ij_islands_offshore.append(points_box_i_j)
...
points_in_boxes_ij_combined = points_in_boxes_ij_continent + points_in_boxes_ij_islands_inshore + points_in_boxes_ij_islands_offshore
