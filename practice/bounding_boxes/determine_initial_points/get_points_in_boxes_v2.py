...
points_in_boxes_file_out_islands = 'z_output/' + 'points_in_boxes_lon_lat_islands.p'
...
points_in_boxes_file_out_combined_ij = 'z_output/' + 'points_in_boxes_i_j_combined.p'
