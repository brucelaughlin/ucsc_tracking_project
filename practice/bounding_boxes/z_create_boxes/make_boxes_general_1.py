    ...
    for jj in range(coast_dex,num_points_coast):
        ...
        if closest_dex == num_points_isoline-1 or jj == num_points_coast-1:
            ...
            if jj == num_points_coast-1:
                ...
                #polygon_i = polygon_wall_onshore_i[:] + list(isoline_i[-1:isoline_dex-1:-1])
                #polygon_j = polygon_wall_onshore_j[:] + list(isoline_j[-1:isoline_dex-1:-1])
                polygon_i = polygon_wall_onshore_i[:] + isoline_i[-1:isoline_dex-1:-1]
                polygon_j = polygon_wall_onshore_j[:] + isoline_j[-1:isoline_dex-1:-1]
        ...
        #polygon_i = polygon_wall_onshore_i[:] + list(isoline_i[closest_dex:isoline_dex-1:-1])
        #polygon_j = polygon_wall_onshore_j[:] + list(isoline_j[closest_dex:isoline_dex-1:-1])
        polygon_i = polygon_wall_onshore_i[:] + isoline_i[closest_dex:isoline_dex-1:-1]
        polygon_j = polygon_wall_onshore_j[:] + isoline_j[closest_dex:isoline_dex-1:-1]
