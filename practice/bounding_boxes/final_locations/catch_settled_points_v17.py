...
# v17: Too many files - need to make input variable, from command line

# v16: I think I know what the "0" problem was.  Also, it's dumb that I had 4 copies of the same code for the seasons - just make a season variable,
#      index with that.
...
#parser.add_argument("tracking_file_dir")
args = parser.parse_args()
tracking_output_dir_pre = args.trackingdir + "/"
#tracking_output_dir_pre = args.tracking_file_dir
