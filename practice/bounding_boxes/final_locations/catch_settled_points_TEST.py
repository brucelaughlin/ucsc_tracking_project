...
model_string = "wc15n"
vertical_mixing_string = "yes"
vertical_motion_string = "yes"
swimming_string = "no"
caption_text = "Model: {}, Vertical Mixing: {}, ,Vertical Motion: {},\n Swimming: {}".format(model_string,vertical_mixing_string,vertical_motion_string,swimming_string)
...
#---------------------------------------------------------------------
# Data to process
tracking_output_dir = '/data03/blaughli/tracking_project_output/trajectory_test/'
#tracking_output_dir = '/data03/blaughli/tracking_project_output/test2_physics_only/'

# Output file
save_output_file_pre = "test_pdf_data.p"
#save_output_file_pre = 'pdf_data_output_seasonal.p'
#save_output_file_pre = 'pdf_data_output.p'
...
save_output_file = save_output_directory + save_output_file_pre
...
counter_array_wrong=np.zeros((num_particles,num_files))
#---------------------------------------------------------------------
            ...
            for inoffshore_switch in range(0,2):
                ...
                for box_lonlat in reversed(boxes_lonlat):
                    ...
                    if box_lonlat is not None:
                        ...
                        counter_array_wrong[:,file_number-1] += particles_inside_flags
...
pickle.dump([pdf_raw,pdf_raw_djf,pdf_raw_mam,pdf_raw_jja,pdf_raw_son,counter_array,counter_array_wrong],file)
file.close()
