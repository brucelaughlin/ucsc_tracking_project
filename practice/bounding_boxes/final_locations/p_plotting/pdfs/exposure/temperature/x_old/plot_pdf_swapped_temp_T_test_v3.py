...
#print(len(cbar_tick_labels_pre))
#print(len(cbar_tick_labels))

cbar_label_2 = "probability"

#cax2 = cbar.ax.twinx()
#cax2.set_ylabel(cbar_label_2, fontsize = cbar_fontSize)
#cax2.locator_params(nbins=cbar_nBins)

#cax2.set_yticklabels(cbar_tick_labels)
#cax2.set_ticklabels(cbar_tick_labels)
...
#cbar2 = cbar.ax.secondary_yaxis('left',functions=(P_to_logP,logP_to_P))
cbar2.set_ylabel(cbar_label_2, fontsize = cbar_fontSize, y=0.87)
#cbar2.set_ylabel(cbar_label_2, fontsize = cbar_fontSize)
