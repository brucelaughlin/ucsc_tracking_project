...
#tick_labels_double_X = tick_labels_double_X[cutoff_dex_pv_label_dex:]
tick_labels_double_Y = tick_labels_double_Y[cutoff_dex_tj_label_dex:]
#tick_positions_Y = tick_positions[cutoff_dex_tj_label_dex:] - tick_positions[cutoff_dex_tj_label_dex]
#tick_positions_X = tick_positions[cutoff_dex_pv_label_dex:] - tick_positions[cutoff_dex_pv_label_dex]
...
for pdf_plot in pdf_list:
    ...
    #ax.plot([0,np.shape(pdf_plot)[1]-1],[0,np.shape(pdf_plot)[0]-1],color="black")
