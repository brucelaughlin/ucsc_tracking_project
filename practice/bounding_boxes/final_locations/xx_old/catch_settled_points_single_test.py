...
# SO I'M CURRENTLY JUST PROCESSING A SINGLE OUTPUT FILE!!!!  MAKE SURE IT WORKS, THEN UN-COMMENT THIS OUTER LOOP,
# TO LOOP OVER ALL OF THE OUTPUT!!!
...
#pdf_raw = np.zeros((n_boxes_settled,n_boxes_seeded))

#X = np.arange(-0.5, n_boxes, 1)
...
#pickle.dump([pdf_raw, num_particles],file)
