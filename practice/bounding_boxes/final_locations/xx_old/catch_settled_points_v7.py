...
#        continue
    ...
    print(np.shape(bio_windows))
    print(np.shape(timestep_bio_window_mask))
    ...
    for time_dex in range(timesteps_settlement_window):
        ...
        #timestep_bio_window_mask = (timestep_bio_window_mask + bio_windows==time_dex).astype(bool)
        #timestep_bio_window_mask = timestep_bio_window_mask + bio_windows==time_dex
        #timestep_bio_window_mask=(bio_windows==time_dex)
        #timestep_bio_window_mask=(bio_windows==time_dex).astype(int)

        print(np.sum(bio_windows==time_dex))
        print(np.sum(timestep_bio_window_mask))
        print("\n")
