...
settlers_timestep_settled = np.zeros((num_particles,num_files))
settlers_assigned_bio_windows = np.zeros((num_particles,num_files))
        ...
        #for island_dex in range(num_last_blob_island,num_islands+1):
            ...
            for box_lonlat in reversed(boxes_lonlat):
                ...
                if box_lonlat is not None:
                    ...
                    #settlers_assigned_bio_windows[:,file_number] = settlers_assigned_bio_windows[:,file_number] + particles_inside_flags * settlement_safety_mask * timestep_bio_window_mask * bio_windows
