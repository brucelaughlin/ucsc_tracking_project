...
pdf_list_exposure_T_source,pdf_list_of_lists_O2_source,pdf_list_connectivity,pdf_list_settleTime,settlement_boxes_test_array,settlement_times_test_array,counter_array,oxygen_limit_list = pickle.load(file)
#pdf_list_exposure_T_source,pdf_list_of_lists_O2_source,pdf_list_connectivity,pdf_list_settleTime,settlement_boxes_test_array,settlement_times_test_array,counter_array = pickle.load(file)
...
pdf_list_of_lists_O2_source_swapped = []
for ii in range(len(pdf_list_of_lists_O2_source)):
    pdf_list_of_lists_O2_source_swapped.append([])
...
for ii in range(len(pdf_list_of_lists_O2_source)):
    for jj in range(len(pdf_list_connectivity)):
        ...
        pfO2_source = np.copy(pdf_list_of_lists_O2_source[ii][jj])
        ...
        pdf_list_of_lists_O2_source_swapped[ii].append(pfO2_source)
...
pickle.dump([pdf_list_exposure_T_source_swapped,pdf_list_of_lists_O2_source_swapped,pdf_list_connectivity_swapped,pdf_list_settleTime_swapped,settlement_boxes_test_array,settlement_times_test_array,counter_array,box_num_mod,tick_positions,tick_labels,first_continent_box_num,oxygen_limit_list],file)
#pickle.dump([pdf_list_exposure_T_source_swapped,pdf_list_of_lists_O2_source_swapped,pdf_list_connectivity_swapped,pdf_list_settleTime_swapped,settlement_boxes_test_array,settlement_times_test_array,counter_array,box_num_mod,tick_positions,tick_labels,first_continent_box_num],file)
#pickle.dump([pdf_list_exposure_T_source_swapped,pdf_list_of_lists_O2_source_swapped,pdf_list_connectivity_swapped,pdf_list_settleTime_swapped,settlement_boxes_test_array,settlement_times_test_array,counter_array,box_num_mod,tick_positions,tick_labels],file)
