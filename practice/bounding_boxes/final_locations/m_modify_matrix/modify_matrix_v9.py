...
pdf_list_of_lists_pH_swapped = []
for ii in range(len(pdf_list_of_lists_pH)):
    pdf_list_of_lists_pH_swapped.append([])
...
for ii in range(len(pdf_list_of_lists_pH)):
    for jj in range(len(pdf_list_connectivity)):
        pfpH = np.copy(pdf_list_of_lists_pH[ii][jj])
        pfpH[dx2_og] = pfpH[dx2_new]
        pdf_list_of_lists_pH_swapped[ii].append(pfpH)
...
d['pdf_list_exposure_T'] = pdf_list_exposure_T_swapped
d['pdf_list_of_lists_O2'] = pdf_list_of_lists_O2_swapped
d['pdf_list_of_lists_pH'] = pdf_list_of_lists_pH_swapped
d['pdf_list_connectivity'] = pdf_list_connectivity_swapped
d['pdf_list_settleTime'] = pdf_list_settleTime_swapped

#d['pdf_list_exposure_T_swapped'] = pdf_list_exposure_T_swapped
#d['pdf_list_of_lists_O2_swapped'] = pdf_list_of_lists_O2_swapped
