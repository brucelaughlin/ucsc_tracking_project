...
run_string = 'floats_{}_saveDT_{}_calcDT_{}'.format(number_of_floats,run_save,run_compute)
...
with open(runtime_text_file,"a") as out_file: 
    #out_file.write('metadata: {}, {}, run_start_day: {}, run_end_day: {}, days: {}, run_dt (seconds): {}, save_dt (seconds): {}, readerloading (mins): {}, run_time (hrs): {}, execution_time (hrs): {}\n'.format(str(number_of_seeds),run_string,start_run_time,end_run_time,run_length_days.days,run_dt.seconds,save_dt.seconds,round(reader_time/60,3),round(total_runtime/3600,3), round(total_execution_time/3600,3))) 
    out_file.write('{}, number_of_seeds: {}, run_start_day: {}, run_end_day: {}, days_running_per_seed: {}, run_dt (seconds): {}, save_dt (seconds): {}, readerloading (mins): {}, run_time (hrs): {}, execution_time (hrs): {}\n'.format(run_string,str(number_of_seeds),start_run_time,end_run_time,run_length_days.days-1,run_dt.seconds,save_dt.seconds,round(reader_time/60,3),round(total_runtime/3600,3), round(total_execution_time/3600,3))) 
