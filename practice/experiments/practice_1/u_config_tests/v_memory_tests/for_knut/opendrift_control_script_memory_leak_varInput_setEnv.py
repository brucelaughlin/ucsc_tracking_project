...
number_of_floats = int(sys.argv[4])
...
tracking_output_file = current_directory + '/z_output/memory_test_output.nc'
memory_output_plot_file = current_directory + '/z_output/memory.png'
...
#o.plot_memory_usage(memory_output_plot_file)
