...
#for ii in "${startNudgeArray[@]}"; do
    #sleep 300 #Bump this up to 600 - 900 for production
    #logString="$(printf %02d ${dtCalc})_$(printf %04d ${dtSave})_$(printf %03d ${bufferLength})_$(printf %02d ${nSeed})_$(printf %02d ${nRuns})_$(printf %03d ${startNudge})"
