...
for ii in ${startNudgeArray[@]}; do
    ...
    python opendrift_run_store_eco_variables_spec_numFloats_dtCalc_dtSave_240409_varStart.py $dtCalc $dtSave $bufferLength $parentDir $nSeed $ii &> z_output/z_logs/log_${logString}.txt &
