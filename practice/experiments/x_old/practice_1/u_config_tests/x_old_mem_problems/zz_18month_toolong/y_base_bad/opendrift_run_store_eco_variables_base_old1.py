...
# This is a base for a test script, in which we add readers for 2 full years (1988 and 1989) of model output
...
end_run_time = start_run_time + relativedelta(months = n_months_run)
...
print('Minutes taken to add custom readers for 2 years: {}'.format(round(reader_time)/3600,3))
#--------------------------------------------------------------------------
...
with open(runtime_text_file,"a") as out_file: 
    #out_file.write('days: {}, run_dt (seconds): {}, save_dt (seconds): {}, test metadata: {}, runtime (hrs): {}, execution (hrs): {}, readerloading: {}, start_time_init: {}, start_time_run: {}, end_time: {}\n'.format(run_length_days.days,run_dt.seconds,save_dt.seconds,test_metadata,round(total_runtime/3600,3), round(total_execution_time/3600,3)), round(reader_time)/3600,3), t_init,t_run_start,t_run_end)    
    out_file.write('metadata: {}, {}, run_start_day: {}, run_end_day: {}, days: {}, run_dt (seconds): {}, save_dt (seconds): {}, test metadata: {}, runtime (hrs): {}, execution (hrs): {}, readerloading: {}, start_time_init: {}, start_time_run: {}, end_time: {}\n'.format(test_metadata,run_string,start_run_time,end_run_time,run_length_days.days,run_dt.seconds,save_dt.seconds,round(total_runtime/3600,3), round(total_execution_time/3600,3)), round(reader_time)/3600,3), t_init,t_run_start,t_run_end)    
