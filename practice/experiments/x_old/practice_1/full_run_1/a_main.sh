...
###############################################################################
experimentDir="test4_physics_only_AKs_1en5"
#experimentDir="test3_physics_only"
#experimentDir="test2_physics_only"
###############################################################################
...
# stops 90 days before last day of last year, to control seeding.  Test this all with script printing relavant output,
