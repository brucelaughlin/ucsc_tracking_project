...
#his_dir1 = sys.argv[7]
#his_dir2 = sys.argv[8]
#his_dir_array = sys.argv[7:]

parser = argparse.ArgumentParser()
parser.add_argument("--runcalc", default=60, type=int)
parser.add_argument("--runsave", default=1440, type=int)
parser.add_argument("--bufferlength", default=100, type=int)
parser.add_argument("--numberofseeds", type=int)
parser.add_argument("--startnudge", type=int)
parser.add_argument("--outputdir", type=str)
parser.add_argument("--hisdirs", nargs=2, type=str)
args = parser.parse_args()

run_calc = args.runcalc
run_save = args.runsave
buffer_length = args.bufferlength
output_dir = args.outputdir
number_of_seeds = args.numberofseeds
start_nudge = args.startnudge
his_dir_1 = args.hisdirs[0]
his_dir_2 = args.hisdirs[1]
...
his_file_1 = his_dir1 + '/' + his_file_wildcard
his_file_2 = his_dir2 + '/' + his_file_wildcard
#his_file_1 = his_dir1 + his_file_wildcard
#his_file_2 = his_dir2 + his_file_wildcard
