...
runString="dtCalc=${dtCalc},dtSave=${dtSave},bufferLength=${bufferLength},parentDir=${parentDir},outputDir=${outputDir},nSeed=${nSeed},nRuns=${nRuns},readerDir1=${readerDir1},readerDir2=${readerDir2}"
...
job_num_pre=$(sbatch --export="ALL,${runString}" a_run_opendrift_test_v1.sh)
