...
#behavior_list = ["physicsOnly", "dvm", "onshoreSwim"]
behavior_list = ["onshoreSwim"]
...
baseOutputDir="/data/blaughli/tracking_output/swim_tests/"
...
projectionDirectories=["dummy_dir"]
...
baseInputDir_pre="/data/blaughli/z_dummy_model_input_10_days/"
...
for ii in range(len(behavior_list)):
    ...
    for projectionNumber in range(len(projectionDirectories)):
        ...
        experimentDir = "{a}_{d}_test".format(a=projectionDirectories[projectionNumber], d=behavior)
