...
#jobDirList=($(sed 's/[.-]//g' <<< $(awk '/jobDirList/,/modelIndex/' $configFile)))
...
for jobRunNum in "${!jobDirList[@]}"; do
    ...
    #python opendrift_run_store_eco_variables_241007_configFile_behaviorSwitch_Test1.py --configfile $configFile --jobrunnumber $jobRunNum &>> "$logFile" &
    python opendrift_run_store_eco_variables_241007_configFile_behaviorSwitch_zeroVel.py --configfile $configFile --jobrunnumber $jobRunNum &>> "$logFile" &
