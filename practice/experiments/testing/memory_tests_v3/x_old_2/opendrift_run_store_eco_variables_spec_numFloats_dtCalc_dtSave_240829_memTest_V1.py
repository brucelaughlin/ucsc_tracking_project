...
parser.add_argument("run_save")
parser.add_argument("buffer_length")
parser.add_argument("output_dir")
parser.add_argument("number_of_seeds")
parser.add_argument("start_nudge")
parser.add_argument("his_dir_1")
parser.add_argument("his_dir_2")
args = parser.parse_args()

run_calc = int(args.run_calc)
run_save = int(args.run_save)
buffer_length = int(args.buffer_length)
output_dir = args.output_dir
number_of_seeds = int(args.number_of_seeds)
start_nudge = int(args.start_nudge)
his_dir_1 = args.his_dir_1
his_dir_2 = args.his_dir_2
