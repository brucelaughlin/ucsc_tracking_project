...
for ii in ${startNudgeArray[@]}; do
    ...
    python opendrift_run_store_eco_variables_spec_numFloats_dtCalc_dtSave_240729_production.py $dtCalc $dtSave $bufferLength $outputDir $nSeed $ii $readerDir1 $readerDir2 &> $outputDir/z_logs/log_${logString}.txt &
