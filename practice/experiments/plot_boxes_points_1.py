...
points_in_boxes_file_in = experiments_dir + 'points_in_boxes_lon_lat_{}_boundary.p'.format(points_line_type)
...
for box in boxes_ij:
    if box is not None:
        ...
        #ax.scatter(points_in_boxes_ij[box_dex][:,1],points_in_boxes_ij[box_dex][:,0], marker = marker_point)
        ax.scatter(rgi_lon((points_in_boxes_ij[box_dex][:,0],points_in_boxes_ij[box_dex][:,1])),rgi_lat((points_in_boxes_ij[box_dex][:,0],points_in_boxes_ij[box_dex][:,1])),marker=marker_point)
