#v2: In v1 I made the mask in a single step, but I think it must happen in two.  Expand horizontally, then vertically, or vice-versa.
...
swim_data_output_file_pre = 'swim_data_simple_v2'
...
mask = mask + buff_south + buff_north
...
onshore_swim_component_x = onshore_swim_component_x.T
onshore_swim_component_y = onshore_swim_component_y.T


# ------------------------------------------------------------------------------------
# Mask the swim vector map
# ------------------------------------------------------------------------------------
#onshore_swim_component_x = onshore_swim_component_x * mask.T
#onshore_swim_component_y = onshore_swim_component_y * mask.T
# ------------------------------------------------------------------------------------


#plt.pcolormesh(lon_field,lat_field,mask)

#plt.pcolormesh(lon_field,lat_field,onshore_swim_component_x.T,cmap='cmo.balance')
#plt.pcolormesh(lon_field,lat_field,onshore_swim_component_y.T,cmap='cmo.balance')
...
#
onshore_swim_component_x_map = onshore_swim_component_x
onshore_swim_component_y_map = onshore_swim_component_y
#
#
#
...
d = {}
d['onshore_swim_component_x_map'] = onshore_swim_component_x_map
d['onshore_swim_component_y_map'] = onshore_swim_component_y_map
d['onshore_swim_component_x'] = onshore_swim_component_x
d['onshore_swim_component_y'] = onshore_swim_component_y
d['lon_flat'] = lon_flat
d['lat_flat'] = lat_flat
d['coord_array'] = coord_array 
d['mask'] = mask 

np.savez(swim_data_output_file, **d)
