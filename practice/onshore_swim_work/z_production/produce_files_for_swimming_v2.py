...
# TEST - reverse the swim directions, to see if beaching stops
onshore_swim_component_x = onshore_swim_component_x * -1
onshore_swim_component_y = onshore_swim_component_y * -1

file = open(swim_data_output_file,'wb')
pickle.dump([mask,mask_flat,coord_array,onshore_swim_component_x,onshore_swim_component_y,neg_grad_norm_map_x,neg_grad_norm_map_y],file)
#pickle.dump([mask,mask_flat,coord_array,onshore_swim_component_x,onshore_swim_component_y],file)
file.close()
