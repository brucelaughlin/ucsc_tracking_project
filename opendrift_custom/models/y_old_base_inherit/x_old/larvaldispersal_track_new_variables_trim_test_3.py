...
class LarvalDispersal(OpenDriftSimulation):
    """Copying OceanDrift, and trying to add behavior for larva
    ...
    def plotter_vertical_distribution_time(self, ax=None, mask=None,
        ...
        y_wind = self.history['y_wind'].T[step, :]
        windspeed = np.mean(np.sqrt(x_wind**2 + y_wind**2))
